...
class SmokesControllerTest < ActionController::TestCase
  ...
  test "should create smoke" do
    assert_difference('Smoke.count') do
      post :create, smoke: { smoke_date: @smoke.smoke_date, smoke_latitude: @smoke.smoke_latitude, smoke_longitude: @smoke.smoke_longitude, user_id: @smoke.user_id }
    end
  ...
  test "should update smoke" do
    patch :update, id: @smoke, smoke: { smoke_date: @smoke.smoke_date, smoke_latitude: @smoke.smoke_latitude, smoke_longitude: @smoke.smoke_longitude, user_id: @smoke.user_id }
    assert_redirected_to smoke_path(assigns(:smoke))
  end
